...
public class GameField : OCGobject
{
    ...
    public void loadOldField()
    {
        ...
        {
            leftT.mainTexture = UIHelper.getTexture2D("textures/", "newfield.png");
            midT.mainTexture = UIHelper.getTexture2D("textures/", "newfield.png");
            rightT.mainTexture = UIHelper.getTexture2D("textures/", "newfield.png");
        }
